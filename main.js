...
let total_sums = [get_sum(lab1), get_sum(lab2), get_sum(lab3), get_sum(lab4_5), get_sum(lab6), get_sum(lab8)]
let total_score = [(get_sum(lab1) + get_sum(lab2) + get_sum(lab3) + get_sum(lab4_5) + get_sum(lab6) + get_sum(lab8)) / 280 * 60 + (quiz1)]
